      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
        ...
        <div className="mt-10 space-y-8">
          ...
          <div>
            ...
            <form className="flex">
              <input type="email" placeholder="Votre email" className="flex-1 p-2 border border-gray-300 rounded-l" />
              <button className="bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-r cursor-pointer">S'inscrire</button>
            </form>
          </div>

          <div className="mt-4">
            <img src="/home/Logo.png" alt="Logo" className="mx-auto w-32" />
          </div>
        </div>
